...
def test_vars():
    jscode_snippets = [
        ...
        (
            ...
            """,
            {"arr1": ["a", None, "c"], "arr2": [None, "e", None]},
        ),
        (
            r"""
            ...
            """,
            {"arr1": ["a", "undefined", "c"], "arr2": ["undefined", "e", None]},
        ),
        (
            r"""
            var i = -3.14;
        ...
        (
            ...
            """,
            {"currency": "USD", "money": {"currency": "currency", "value": 20}},
        ),
        (
            r"""
            t = {a: "3", "b": 3, "3": 3.0};
        ...
        (
            ...
            """,
            {"store": {"apples": 10, "carrots": [1, 2, 3, 4], "chicken": {"eggs": [5, 6, 7, 8]}}},
        ),
        (
            r"""
            var store1 = {
